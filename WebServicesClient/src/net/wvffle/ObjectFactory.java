 ...
 * generated in the net.wvffle package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://wvffle.net/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://wvffle.net/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.wvffle
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wvffle.net/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wvffle.net/", name = "getHelloWorldAsString")
